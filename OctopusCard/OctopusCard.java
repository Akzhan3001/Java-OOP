...
public class OctopusCard {
    ...
    private void start(String ocTransactionDBFName) {
        ...
        while (!quit) {
            ...
            switch (cmd.toLowerCase()) {
                case "load":   loadCmd(tokens);        break;
                case "save":   saveCmd(tokens);        break;
                case "list":   listCmd(tokens);        break;
                case "add":    addCmd(tokens);         break;
                case "search": searchCmd(tokens);      break;
    ...
    private void searchCmd(String [] tokens) {
        ...
        } catch (OCTransaction.OCTransactionSearchException | ParseException e) {
